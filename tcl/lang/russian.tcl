...
set tips(R) {
  ...
  {
    Вы можете добавить наиболее распространенные символы аннотации (!, !?, += и т. д.) к текущему перемещению или позиции с помощью сочетаний клавиш без необходимости использования редактора комментариев <a Comment> <a> — например, введите "!" затем клавишу Return, чтобы добавить "!" символ аннотации. Подробности смотрите на странице справки <a Moves>Ввод шахматных ходов</a>.
  }
  {
