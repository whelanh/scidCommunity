...
proc ::iccf::updateGames {} {
  ...
  foreach game $::iccf::games {
    ...
    if {$dbGameNum > 0} {
      ...
      set tagsChanged [::iccf::syncGameTags $game $id $dbGameNum "ICCF"]
...
proc ::iccf::addNewGame {game lssId tagName} {
  ...
  # Set tags
  set extraTags [::iccf::buildExtraTags $game $lssId $tagName]
...
#
# ::iccf::buildExtraTags - Build the list of managed extra PGN tags
#   ("Name \"value\"" entries) for a server game
#
proc ::iccf::buildExtraTags {game lssId tagName} {
...
#
# ::iccf::syncGameTags - Refresh the PGN headers of an existing database game
...
#
proc ::iccf::syncGameTags {game lssId dbGameNum tagName} {
  ...
  set managedNames {ICCF TimeControl WhiteTitle BlackTitle WhiteNA BlackNA \
  ...
  set newManaged [::iccf::buildExtraTags $game $lssId $tagName]
