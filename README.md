...
21. Another [user idea](https://github.com/whelanh/scidCommunity/discussions/44) lead to the development of an "Auto Comment" and "Game Comment" buttons Engine windows. The "Auto Comment" button generates AI chess commentary for a move. The "Game Comment " button will provide comments for moves that have annotations and a game summary. 
